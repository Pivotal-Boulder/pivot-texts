...
public class PivotTextsApiApplicationTest {
    ...
    public void testPivotTexts() {
        ...
        ResponseEntity<String> stringResponseEntity = restTemplate.postForEntity("http://localhost:" + port + "/twilio-texts", requestEntity, String.class);
        assertThat(stringResponseEntity.getStatusCode(), equalTo(HttpStatus.OK));

        PivotText[] pivotTexts = restTemplate.getForObject("http://localhost:" + port + "/pivot-texts/today", PivotText[].class);
